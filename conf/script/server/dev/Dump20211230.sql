...
CREATE TABLE `cluster` (
  ...
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='cluster 관리 테이블';
...
CREATE TABLE `service` (
  ...
  `UPDATED` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='SERVICE 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='service step 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-12-30  1:34:02
