...
CREATE TABLE `client` (
  ...
  `AGENT_ID` varchar(45) COLLATE utf8_bin NOT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='client 관리 테이블';
...
CREATE TABLE `service` (
  ...
  `UPDATED` timestamp NULL DEFAULT current_timestamp(),
  PRIMARY KEY (`ID`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='SERVICE 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COLLATE=utf8_bin COMMENT='service step 관리 테이블';
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2022-01-03 14:04:53
