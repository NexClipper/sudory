...
const docTemplate = `{
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/service.HttpReq_ClientServiceUpdate"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/cluster_token.HttpRsp_ClusterToken"
                            }
                        }
                    }
                }
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cluster_token.HttpReq_ClusterToken_create"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/cluster_token.HttpReq_ClusterToken_update"
                        }
                    }
                ],
                "responses": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/service.HttpRsp_ServiceStep"
                            }
                        }
                    }
                }
    ...
    "definitions": {
        ...
        "cluster_token.HttpReq_ClusterToken_create": {
            "type": "object",
            "properties": {
                "cluster_uuid": {
                    "type": "string"
        ...
        "cluster_token.HttpReq_ClusterToken_update": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string"
        ...
        "cluster_token.HttpRsp_ClusterToken": {
            "type": "object",
            "properties": {
                "cluster_uuid": {
                    "type": "string"
