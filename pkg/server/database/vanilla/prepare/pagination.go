...
func newPaginationBuilder(page *Pagination) *paginationEngine {
	engine := paginationEngine{}

	builtin := map[string]PaginationFunctor{
		"limit": engine.MakePaginationFunc(page),
		"page":  engine.MakePaginationFunc(page),
	}
...
func (builder *paginationEngine) Parse(v interface{}) error {
...
func (builder *paginationEngine) MakePaginationFunc(page *Pagination) func(v interface{}) error {
