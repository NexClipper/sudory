...
type DbMeta struct {
	//아이디 PK
	Id uint64 `json:"id" xorm:"bigint notnull pk autoincr 'id' comment('db_meta's id')"`
	//생성시간
...
type LabelMeta struct {
	...
	//label summary
	Summary *string `json:"summary,omitempty" xorm:"varchar(255) null 'summary' comment('label_meta's summary')"`
	//api version
	ApiVersion string `json:"api_version" xorm:"varchar(255) notnull 'api_version' comment('label_meta's api version')"`
}
